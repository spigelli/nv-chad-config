...
M.named = {
  green = "#7ee787",
  light_green = "#85e89d", -- Deprecated, open/close embedded tags
  white = "#c9d1d9", -- Default fg (caret, delimiters, Operators)
  purple = "#B392E9", -- Variables, XML Tags, Markup Link Text, Markup Lists, Diff Deleted
  orange = "#ffab70", -- Integers, Boolean, Constants, XML Attributes, Markup Link Url
  yellow = "#ffdf5d", -- Classes, Markup Bold, Search Text Background
  light_blue = "#a5d6ff", -- Strings, Inherited Class, Markup Code, Diff Inserted
  blue = "#83caff", -- Support, regex, escape chars
  med_blue="#79c0ff",
  dark_blue = "#6AB1F0", -- Function, methods, headings
  red = "#ff7f8d", -- Keywords
}
